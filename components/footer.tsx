      ...
      <div className="container px-4 mx-auto">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><span className="text-gray-400">Tejaswi Deepam Oil</span></li>
              <li><span className="text-gray-400">Coco True Coconut Oil</span></li>
              <li><span className="text-gray-400">Traditional Oil Products</span></li>
              <li><span className="text-gray-400">Custom Orders</span></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-gray-400 text-sm">
              © 2024 Shri Mandarathi Products. All rights reserved.
            </p>
