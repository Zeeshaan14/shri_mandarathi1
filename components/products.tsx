...
import { Star, Droplets, Leaf, Award } from 'lucide-react'

export function Products() {
  const products = [
    {
      name: "Tejaswi Deepam Oil",
      description: "Premium quality oil perfect for traditional lamps and religious ceremonies. Made with the finest ingredients for a pure, long-lasting flame.",
      image: "/placeholder-pyim3.png",
      features: ["Long burning", "Smokeless", "Pure ingredients", "Traditional recipe"],
      category: "Lamp Oil"
    },
    {
      name: "Coco True 100% Pure Coconut Oil",
      description: "Extracted from fresh coconuts using traditional methods. Perfect for cooking, hair care, and skincare. No additives, no preservatives.",
      ...
      <div className="container px-4 mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Discover our range of pure, natural oil products crafted with traditional methods 
