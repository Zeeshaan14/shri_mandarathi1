  ...
  const products = [
    {
      ...
      description:
        "Premium quality oil perfect for traditional lamps and religious ceremonies. Made with the finest ingredients for a pure, long-lasting flame.",
      image: "/placeholder.svg?height=400&width=400&text=Tejaswi+Deepam+Oil",
    ...
    },
    {
      ...
      description:
        "Extracted from fresh coconuts using traditional methods. Perfect for cooking, hair care, and skincare. No additives, no preservatives.",
